        ...
        <div >
            ...
            <StyledContactForm className="contactForm">
                <form ref={form} onSubmit={sendEmail}>
                 ...
                 <p style={{width:"50%", marginTop:"10%"}}>If you'd like to connect with me on LinkedIn, feel free to search for my name and send a connection request. Explore my GitHub profile to discover some of my coding projects that you might find interesting. The repositories showcase my latest work and coding endeavours. Feel free to reach out if you have any questions or want to connect. I appreciate your interest.</p>
            ...
            >
                ...
                <a href="https://www.linkedin.com/in/omar-ibrahim-aaba3344/" target="_blank">
                <motion.div 
                initial={{opacity:0, x:-60}}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5 }}  
